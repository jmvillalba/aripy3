...
class ARIClient(object):
    ...
    async def connect(self, base_url, http_client):
        url = urllib.parse.urljoin(base_url, "ari/api-docs/resources.json")

        self.swagger = swaggerpy3.client.SwaggerClient()
        await self.swagger.connect(
    ...
    async def __run(self, ws):
        ...
        while True:
            ...
            msg_json = json.loads(msg_str.data)
    ...
    async def on_event(self, event_type, event_cb, *args, **kwargs):
    ...
    async def on_object_event(self, event_type, event_cb, factory_fn, model_id,
                        *args, **kwargs):
        ...
        async def extract_objects(event, *args, **kwargs):
            ...
            if len(obj_fields) == 1:
                if obj:
                    ...
                    obj = None
            await event_cb(obj, event, *args, **kwargs)

        return await self.on_event(event_type, extract_objects,
                             *args,
                             **kwargs)

    async def on_channel_event(self, event_type, fn, *args, **kwargs):
        ...
        """
        return await self.on_object_event(event_type, fn, Channel, 'Channel', *args, **kwargs)

    async def on_bridge_event(self, event_type, fn, *args, **kwargs):
        ...
        :param kwargs: Keyword arguments to pass to fn
        """
        return await self.on_object_event(event_type, fn, Bridge, 'Bridge',
                                    *args, **kwargs)

    async def on_playback_event(self, event_type, fn, *args, **kwargs):
        ...
        :param kwargs: Keyword arguments to pass to fn
        """
        return await self.on_object_event(event_type, fn, Playback, 'Playback', *args, **kwargs)

    async def on_live_recording_event(self, event_type, fn, *args, **kwargs):
        ...
        :param kwargs: Keyword arguments to pass to fn
        """
        return await self.on_object_event(event_type, fn, LiveRecording,
                                    'LiveRecording', *args, **kwargs)

    async def on_stored_recording_event(self, event_type, fn, *args, **kwargs):
        ...
        :param kwargs: Keyword arguments to pass to fn
        """
        return await self.on_object_event(event_type, fn, StoredRecording,
                                    'StoredRecording', *args, **kwargs)

    async def on_endpoint_event(self, event_type, fn, *args, **kwargs):
        ...
        :param kwargs: Keyword arguments to pass to fn
        """
        return await self.on_object_event(event_type, fn, Endpoint, 'Endpoint',
                                    *args, **kwargs)

    async def on_device_state_event(self, event_type, fn, *args, **kwargs):
        ...
        :param kwargs: Keyword arguments to pass to fn
        """
        return await self.on_object_event(event_type, fn, DeviceState, 'DeviceState',
                                    *args, **kwargs)

    async def on_sound_event(self, event_type, fn, *args, **kwargs):
        ...
        :param kwargs: Keyword arguments to pass to fn
        """
        return await self.on_object_event(event_type, fn, Sound, 'Sound',
                                    *args, **kwargs)
